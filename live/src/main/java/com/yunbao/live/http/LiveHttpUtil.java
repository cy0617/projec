...
public class LiveHttpUtil {
     ...
     * @param callback
     */
    public static void createRoom(String title, int liveClassId, int type, String typeVal, int isShop, File file, boolean openLocation, HttpCallback callback) {
    ...
    public static void getLiveStickerList(String beautyKey, final CommonCallback<String> commonCallback) {
        String packageName = CommonAppContext.sInstance.getPackageName();
     ...
     * @param callback
     */
    public static void delLiveRecord(String id, HttpCallback callback) {
        HttpClient.getInstance().get("user.delLiverecord", LiveHttpConsts.LIVE_DEL_LIVERECORD)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("id", id)
                .execute(callback);
    ...
    public static void setOrderClick(String id, HttpCallback callback) {
        HttpClient.getInstance().get("seller.setOrderClick", LiveHttpConsts.SET_ORDER_CLICK)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("id", id)
                .execute(callback);
     ...
     * @param callback
     */
    public static void setShopTalking(String id, int type, HttpCallback callback) {
        HttpClient.getInstance().get("shop.setShopTalking", LiveHttpConsts.SET_SHOP_TALKING)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("id", id)
                .params("type", type)
