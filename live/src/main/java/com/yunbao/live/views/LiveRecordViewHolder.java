...
public class LiveRecordViewHolder extends AbsUserHomeViewHolder implements OnItemClickListener<LiveRecordBean> {
    ...
    public void onLiveRecordDeleteEvent(LiveRecordDeleteEvent event){
     ...
     * 获取直播回放的url并跳转
     */
    private void fowardLiveRecord(final String recordId) {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0) {
                    ...
                    if (mActionListener != null) {
                        ...
                        if (userBean != null) {
                            LiveRecordPlayActivity.forward(mContext, url, userBean,recordId);
                        }
                    }
                } else {
                    ToastUtil.show(msg);
