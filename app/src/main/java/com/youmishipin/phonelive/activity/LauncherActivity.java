package com.youmishipin.phonelive.activity;
...
import com.youmishipin.phonelive.AppContext;
import com.youmishipin.phonelive.R;
    ...
    private void getConfig() {
        ...
        CommonHttpUtil.getConfig(new CommonCallback<ConfigBean>() {
            ...
            public void callback(ConfigBean bean) {
                if (bean != null) {
                    AppContext.sInstance.initBeautySdk(DecryptUtil.decrypt(bean.getBeautyKey()));
