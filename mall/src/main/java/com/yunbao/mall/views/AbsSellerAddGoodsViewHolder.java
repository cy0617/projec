...
import com.yunbao.mall.activity.ChooseGoodsClassActivity;
 ...
 * 卖家添加商品
 */
public abstract class AbsSellerAddGoodsViewHolder extends AbsMainViewHolder implements View.OnClickListener {

    public AbsSellerAddGoodsViewHolder(Context context, ViewGroup parentView, String goodsId) {
    ...
    public void init() {
        ...
        findViewById(R.id.btn_goods_class).setOnClickListener(this);
    ...
    private void submit() {
        ...
        if (mEtGoodLinks != null) {
            mGoodLinks = mEtGoodLinks.getText().toString().trim();
    ...
    private void saveGoodsInfo() {
        ...
        MallHttpUtil.setGoods(
                ...
                new HttpCallback() {
                    ...
                    public void onSuccess(int code, String msg, String[] info) {
                        if (code == 0) {
                            ((SellerAddGoodsActivity) mContext).finish();
                        }
                        ToastUtil.show(msg);
                    }
    ...
    public void setGoodLinks(String goodLinks) {
        mGoodLinks = goodLinks;
    }
}
