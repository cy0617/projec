...
//        oks.setImageUrl(data.getImgUrl());
        oks.setImageUrl(CommonAppConfig.HOST + "/default.jpg");
    ...
    public void shareImage(Context context, String platType, String imagePath, MobCallback callback) {
        ...
        if (platName.equals(QQ.NAME)||platName.equals(QZone.NAME)) {
...
//                return;
//            }
//            Tencent tencent = Tencent.createInstance("101551222", context); //腾讯开放平台appid
