...
public class CommonAppConfig {
    ...
    //小程序的ID
    private static String xCxId = null;
    //小程序的原始id
    ...
    public String getAppName() {
        if (TextUtils.isEmpty(mAppName)) {
            int res = CommonAppContext.sInstance.getResources().getIdentifier("app_name", "string", "com.youmishipin.phonelive");
    ...
    public int getAppIconRes() {
        if (mAppIconRes == 0) {
            mAppIconRes = CommonAppContext.sInstance.getResources().getIdentifier("ic_launcher", "mipmap", "com.youmishipin.phonelive");
        }
        return mAppIconRes;
    }
    ...
    public List<UserItemBean> getUserItemList() {
        if (mUserItemList == null || mUserItemList.size() == 0) {
            ...
            if (!TextUtils.isEmpty(userBeanJson)) {
                ...
                if (obj != null) {
                    setUserItemList(obj.getString("list"),obj.getString("list2"));
                }
            }
        }
    ...
    public void setUserItemList(String listString,String listString2) {
        List<UserItemBean> list = JSON.parseArray(listString, UserItemBean.class);
        List<UserItemBean> list2 = JSON.parseArray(listString2, UserItemBean.class);
        for (int i = 0; i <list2.size() ; i++) {
            list2.get(i).setMore(true);
        }
       if (mUserItemList==null){
        ...
        userItemBean.setName(WordUtil.getString(R.string.me_live_center));
        userItemBean.setGroupTop(true);
        UserItemBean userItemBean2=new UserItemBean() ;
        userItemBean2.setName(WordUtil.getString(R.string.me_more));
        userItemBean2.setGroupTop(true);
        mUserItemList.add(userItemBean);
        mUserItemList.add(userItemBean2);
        mUserItemList.addAll(1,list);
        mUserItemList.addAll(list.size()+2,list2);
    }
...
//    public static String getxCxId(Context context) {
//        initXcXId(context);
//        return xCxId;
//    }
//
//    public static String getOriginalXcxId(Context context) {
//        initXcXId(context);
//        return originalXcxId;
//    }
//
//    private static void initXcXId(Context context) {
//        if (xCxId == null || originalXcxId == null) {
//            try {
//                InputStream inputStream = context.getAssets().open("ShareSDK.xml");
//                Document document = XmlUtil.loadNode(inputStream);
//                NodeList nodeList = document.getElementsByTagName("Wechat");
//                NamedNodeMap map = nodeList.item(0).getAttributes();
//                xCxId = map.getNamedItem("AppId").getNodeValue();
//                originalXcxId = map.getNamedItem("small_program_id").getNodeValue();
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//        }
