...
public class UserBean implements Parcelable {
    ...
    @JSONField(name = "getdynamics")
    public long getDynamics() {
        return dynamics;
    }

    @JSONField(name = "getdynamics")
    public void setDynamics(long dynamics) {
        this.dynamics = dynamics;
    }
    @JSONField(name = "getloves")
