...
public class ConfigBean {
    ...
    private String liveback_siteurl;
    private String liveback_share_title;
    private String liveback_share_des;
    ...
    public String getLiveback_siteurl() {
        return liveback_siteurl;
    }

    public void setLiveback_siteurl(String liveback_siteurl) {
        this.liveback_siteurl = liveback_siteurl;
    }

    public String getLiveback_share_title() {
        return liveback_share_title;
    }

    public void setLiveback_share_title(String liveback_share_title) {
        this.liveback_share_title = liveback_share_title;
    }

    public String getLiveback_share_des() {
        return liveback_share_des;
    }

    public void setLiveback_share_des(String liveback_share_des) {
        this.liveback_share_des = liveback_share_des;
    }
}
