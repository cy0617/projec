...
public class AuthWebViewActivity extends AbsActivity {
    ...
    @Override
    protected void main() {
        final String url = getIntent().getStringExtra(Constants.URL);
        L.e("H5--->" + url);
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                } else if (url.startsWith(Constants.AUTH_PAY)) {
                    String content = url.substring(Constants.AUTH_PAY.length());
                    pay(content);
                } else {
                    view.loadUrl(url);
                }
...
//        Log.e("ttttttttttttttttttt", "forward: "+url);
        Intent intent = new Intent(context, AuthWebViewActivity.class);
...
//            mPayPresenter.setAliPrivateKey(obj.getString("aliapp_key_android"));
            ...
            //int payType = obj.getIntValue("paytype");
            mPayPresenter.payHasOrderId(2, obj);
        }
    }
