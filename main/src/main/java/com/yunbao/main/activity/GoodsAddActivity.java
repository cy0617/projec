...
import com.yunbao.main.views.GoodsAddTaoBaoViewHolder;
import com.yunbao.main.views.GoodsAddXcxViewHolder;
...
public class GoodsAddActivity extends AbsActivity {
    ...
    private boolean mIsOpenApplets = false;
    ...
    protected void main() {
        if (mIsOpenApplets) {
            PAGE_COUNT = 2;
            mTitles = new String[]{WordUtil.getString(R.string.goods_add_taobao), WordUtil.getString(R.string.goods_add_xcx)};
        } else {
            PAGE_COUNT = 1;
            mTitles = new String[]{WordUtil.getString(R.string.goods_add_taobao)};
        }
    ...
    private void loadPageData(int position) {
        ...
        if (vh == null) {
            if (mViewList != null && position < mViewList.size()) {
                ...
                if (position == 0) {
                    vh = new GoodsAddTaoBaoViewHolder(mContext, parent);
                } else if (position == 1) {
                    vh = new GoodsAddXcxViewHolder(mContext, parent);
                }
