package com.yunbao.beauty.ui.views.BadgeRadioButton;
...
/**
 * 带标记的 RadioButton，支持 drawableTop 的按钮
 *
 * 使用时直接 setBadgeNum
...
//            LogUtil.e("BadgeRadioButton","onDraw1","maxPadding = "+maxPadding);
//            LogUtil.e("BadgeRadioButton","onDraw1","mBadgePadding = "+mBadgePadding);
            if (mBadgePadding > maxPadding) {
                if (mBadgePadding - maxPadding > mBadgeOffY) {
                    mBadgeOffY = (int) (mBadgePadding - maxPadding);
//                    LogUtil.e("BadgeRadioButton","onDraw1","mBadgeOffY = "+mBadgeOffY);
                }
            }
            ...
            showShadowImpl(mBadgeShowShadow, mBadgeBackgroundPaint);
            float maxPadding = getOffSize();
//            LogUtil.e("BadgeRadioButton","onDraw2","maxPadding = "+maxPadding);
//            LogUtil.e("BadgeRadioButton","onDraw2","mBadgePadding = "+mBadgePadding);
            if (mBadgePadding > maxPadding) {
                if (mBadgePadding - maxPadding > mBadgeOffY) {
                    mBadgeOffY = (int) (mBadgePadding - maxPadding);
//                    LogUtil.e("BadgeRadioButton","onDraw2","mBadgeOffY = "+mBadgeOffY);
                }
            }
    ...
    private void drawWithNoDrawable(Canvas canvas) {
        ...
        if (mBadgeText.length() == 0) {
            ...
            } else if (mGravity == Gravity.START) {
...
//                LogUtil.e("BadgeRadioButton","drawWithDrawable1","mBadgeOffY = "+mBadgeOffY);
//                LogUtil.e("BadgeRadioButton","drawWithDrawable1","mBadgePadding = "+mBadgePadding);
            } else if (mGravity == Gravity.END) {
                canvas.drawCircle(getWidth() - mFontWidth / 2 - mBadgePadding, mFontHeight / 2 + mBadgeOffY, mFontHeight / 2 + mBadgePadding, mBadgeBackgroundPaint);
            } else if (mGravity == Gravity.START) {
                canvas.drawCircle(mFontWidth / 2 + mBadgePadding, mFontHeight / 2 + mBadgeOffY, mFontHeight / 2 + mBadgePadding, mBadgeBackgroundPaint);
            ...
            canvas.drawRoundRect(mBadgeBackgroundRect, mFontHeight / 2 + mBadgePadding, mFontHeight / 2 + mBadgePadding, mBadgeBackgroundPaint);
//            LogUtil.e("BadgeRadioButton","drawWithDrawable2","mBadgeOffY = "+mBadgeOffY);
//            LogUtil.e("BadgeRadioButton","drawWithDrawable2","mBadgePadding = "+mBadgePadding);
        }
        //绘制文本
        if (mGravity == Gravity.END) {
            canvas.drawText(mBadgeText, getWidth() - mFontWidth - mBadgePadding, mFontHeight + mBadgeOffY, mBadgeTextPaint);
     ...
     * 设置显示数字
     *
     * @param badgeNumber 标记数字 注意 设置为0为一个红点，小于0则没有
     */
    public BadgeRadioButton setBadgeNumber(int badgeNumber) {
        ...
        if (badgeNumber < 0) {
            ...
            mBadgeText = mBadgeExact ? String.valueOf(badgeNumber) : "99+";
        } else if (badgeNumber > 0) {
            mBadgeText = String.valueOf(badgeNumber);
        } else{
            mBadgeText = "";
        }
...
//            mDrawableBackground.setBounds(0, 0, 46, 52);
        }
    ...
    /**
     * 设置标记的位置
     * 目前仅支持Gravity.START Gravity.END Gravity.CENTER，默认Gravity.CENTER
     *
